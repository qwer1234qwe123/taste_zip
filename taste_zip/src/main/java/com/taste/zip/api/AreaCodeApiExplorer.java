...
@Slf4j
public class AreaCodeApiExplorer {
    public static <T> T getApiJsonData(String serviceKey, String srcUrl, String pageNo, String numOfRows, String areaCode, Class<T> vo) 
